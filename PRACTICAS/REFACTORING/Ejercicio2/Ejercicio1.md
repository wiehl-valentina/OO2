Realice en forma iterativa los siguientes pasos: </br>
  * indique el mal olor, </br>
  * (ii) indique el refactoring que lo corrige, </br>
  * (iii) aplique el refactoring, mostrando el resultado final (código y/o diseño según corresponda). </br>
